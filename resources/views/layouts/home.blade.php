...
<head>
    ...
    <link rel="icon" href="../template/assets/img/brand/wikramalogo.png" type="image/png">
    ...
    <div class="col-6 col-xl-2">
      ...
      <div class="navbar-collapse collapse show" id="navbarCollapse">
        ...
        <ul class="navbar-nav site-menu main-menu">
                  <li class="nav-item">
                    <a class="nav-link mr-4 text-white "  href="{{ route('home') }}">Home</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link mr-4 text-white "  href="{{ route('tentang') }}">Tentang</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link mr-4 text-white "  href="{{ route('berita') }}">Berita</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link mr-4 text-white "  href="{{ route('kontak') }}">Galeri</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link mr-4 text-white "  href="{{ route('galeri') }}">Kontak</a>
                  </li>
          </ul>
        </form>
      </div>
